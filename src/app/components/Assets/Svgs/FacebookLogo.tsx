...
export default (props: PropsWithChildren<unknown>) => (
  <svg viewBox="0 0 400 400" {...props}>
    ...
    <g>
      ...
      <path d="M323.5 350.9c8.5 0 15.3-7.5 15.3-16.7V65.7c0-9.2-6.9-16.7-15.3-16.7h-247c-8.5 0-15.3 7.5-15.3 16.7v268.6c0 9.2 6.9 16.7 15.3 16.7h247z" className="facebook_svg__st4" />
      <path
