...
export default (props: PropsWithChildren<unknown>) => (
  <svg viewBox="0 0 400 400" {...props}>
    <style>{'.linkedin_svg__st0{display:none}.linkedin_svg__st1{display:inline}.linkedin_svg__st3{fill:#fff}.linkedin_svg__st4{display:inline;fill:#3d5a98}.linkedin_svg__st6{fill:#007bb5}'}</style>
    ...
    <g className="linkedin_svg__st0">
      ...
      <path d="M323.5 350.9c8.5 0 15.3-7.5 15.3-16.7V65.7c0-9.2-6.9-16.7-15.3-16.7h-247c-8.5 0-15.3 7.5-15.3 16.7v268.6c0 9.2 6.9 16.7 15.3 16.7h247z" className="linkedin_svg__st4" />
      <path
        fill="#fff"
    ...
    <g>
      ...
      <path d="M318.1 58.5H79.8c-11.4 0-20.6 9-20.6 20.1V318c0 11.1 9.3 20.2 20.6 20.2h238.3c11.4 0 20.7-9 20.7-20.2V78.7c0-11.1-9.3-20.2-20.7-20.2z" className="linkedin_svg__st6" />
      <path
