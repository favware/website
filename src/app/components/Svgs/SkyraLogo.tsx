...
export default (props: PropsWithChildren<unknown>) => {
  ...
  return (
    <svg className={classes.root} viewBox="0 0 259.05 518.05" {...props} height="32">
      <g>
        <g>
          <path
            ...
            fill="#fff"
          />
          <path d="M240.45 401.85l2.65-2.8V379.1L129.55 518.05l110.9-116.2m2.65-29.25v-32L129.55 518.05 243.1 372.6M16 145.45v32L129.5 0 16 145.45m2.6-29.25L16 119v20L129.5 0z" fill="#4e5d94" />
        </g>
      </g>
    </svg>
  );
