...
const routes: Routes = [
  ...
  {
    path: 'create-djsbot',
    component: CreateDjsBotComponent
  },
  {
    path: 'skyra',
    component: SkyraComponent
  },
  {
  ...
  },
  {
    ...
    data: { externalUrl: DISCORD_SERVER_URL }
  },
  {
    path: 'redirect/github',
    canActivate: [RedirectGuardComponent],
    component: RedirectGuardComponent,
    data: { externalUrl: GITHUB_PROFILE }
  },
  {
    path: 'redirect/dexa',
    canActivate: [RedirectGuardComponent],
    component: RedirectGuardComponent,
    data: { externalUrl: DEXA_SKILL_URL }
  },
  {
    path: 'redirect/dexa-alexa',
    canActivate: [RedirectGuardComponent],
    component: RedirectGuardComponent,
    data: { externalUrl: DEXA_SKILL_URL }
  },
...
@NgModule({
  declarations: [RedirectGuardComponent],
  imports: [
