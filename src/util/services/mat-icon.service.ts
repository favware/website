...
export class MatIconService {
  ...
  init () {
    ...
    this.matIconRegistry.addSvgIcon(
      'mat-discord-icon',
      this.domSanitizer.bypassSecurityTrustResourceUrl(`assets/svgs/discord.svg`)
    );
    ...
    this.matIconRegistry.addSvgIcon(
      'mat-reddit-icon',
      this.domSanitizer.bypassSecurityTrustResourceUrl(`assets/svgs/reddit.svg`)
    );
    ...
    this.matIconRegistry.addSvgIcon(
      ...
      this.domSanitizer.bypassSecurityTrustResourceUrl(`assets/svgs/icon-puzzle.svg`)
    );

    this.matIconRegistry.addSvgIcon(
      'mat-tava-star-icon',
      this.domSanitizer.bypassSecurityTrustResourceUrl(`assets/svgs/icon-star.svg`)
    );

    this.matIconRegistry.addSvgIcon(
      'mat-tava-temple-icon',
      this.domSanitizer.bypassSecurityTrustResourceUrl(`assets/svgs/icon-temple.svg`)
    );
  }
}
